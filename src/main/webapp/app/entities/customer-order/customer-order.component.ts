...
export class CustomerOrderComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.customerOrderService
      ...
      .subscribe(
        (res: HttpResponse<ICustomerOrder[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCustomerOrders(): void {
    this.eventSubscriber = this.eventManager.subscribe('customerOrderListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICustomerOrder[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
