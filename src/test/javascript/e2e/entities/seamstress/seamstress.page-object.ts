...
export class SeamstressComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-seamstress div table .btn-danger'));
  title = element.all(by.css('jhi-seamstress div h2#page-heading span')).first();
...
export class SeamstressUpdatePage {
  pageTitle = element(by.id('jhi-seamstress-heading'));
...
export class SeamstressDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-seamstress-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-seamstress'));
