...
import { BearComponent } from 'app/entities/bear/bear.component';
import { BearService } from 'app/entities/bear/bear.service';
import { Bear } from 'app/shared/model/bear.model';

describe('Component Tests', () => {
  describe('Bear Management Component', () => {
    let comp: BearComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BearComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bears && comp.bears[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
